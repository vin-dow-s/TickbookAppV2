...
const DeleteDetailsEquipmentDialogBoxHeader = styled(DialogHeader)`
    position: relative;
    color: black;
    background: #ff4437;
...
const DeleteEquipmentDialogBox = ({
    ...
    return (
        <DialogBoxContainer ref={dialogRef}>
            <DeleteDetailsEquipmentDialogBoxHeader ref={headerRef}>
                {`Delete Equip Ref: ${equipmentData.Ref}`}
                <CloseIcon $variant="black" onClose={onClose} />
            </DeleteDetailsEquipmentDialogBoxHeader>
            <DialogContent>
